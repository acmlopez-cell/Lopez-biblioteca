...
export const NAVIGATION: NavigationItem[] = [
  ...
  // -----------------------------------------------------------------------
  {
    id: 'administracion-libros',
    label: 'Administración de Libros',
    description: 'Gestiona los libros de la plataforma',
    children: [
      {
        id: 'administracion-libros/lista',
        label: 'Libros',
        icon: 'book-open',
        route: '/admin/administracion-libros',
